                    ...
                    <div class="w-lg-500px p-10">
                        ...
                        <form class="form w-100" id="kt_sign_in_form" action="{{ route('login.post') }}" method="POST">
                            ...
                            <div class="d-flex flex-stack flex-wrap gap-3 fs-base fw-semibold mb-8">
                                ...
                                <!--begin::Link-->
                                <a href="../../demo10/dist/authentication/layouts/corporate/reset-password.html" class="link-primary">Forgot Password ?</a>
                                <!--end::Link-->
                            </div>
                            <!--end::Wrapper-->
                            <!--begin::Submit button-->
                            <div style="visibility: hidden;" class="d-grid mb-10">
